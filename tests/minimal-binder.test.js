...
assert.equal(source.includes("// @version      0.4.12"), true);
...
assert.equal(source.includes("button:not(.hkb-icon-btn):not(.hkb-key-toggle):not(.hkb-key-rotate){box-sizing:border-box;height:36px;min-height:36px;line-height:20px"), true);
